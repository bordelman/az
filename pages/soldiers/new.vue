<template>
  <section class="soldier">
    <div>
      Osobní číslo:
      <input type="text" v-model="soldier.personalNumber" />
    </div>
    <div>
      Hodnost:
    ...
    <div>
      Křestní jméno:
      <input type="text" v-model="soldier.firstname" />
    </div>
    <div>
      Příjmení:
      <input type="text" v-model="soldier.lastname" />
    </div>
    <div>
      Email:
      <input type="email" v-model="soldier.email" />
    </div>
    <div>
      Mobil:
      <input type="tel" v-model="soldier.mobile" />
    </div>
    <div>
      Pozice:
